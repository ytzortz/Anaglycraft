...
# import os
import time 
from real_code_files.utils import grayscale, get_non_white_pixel_locations_from_image, add_padding
...
for i in range(1, 2):
    ...
    grayImage = grayscale(f"/Users/yiannis/Desktop/ptixiaki/ptixiaki/srcOLDFILES/images/imagesBefore/{i}.png", False)
