...
grayImage = grayscale(f"/Users/yiannis/Desktop/ptixiaki/ptixiaki/srcOLDFILES/images/imagesBefore/1.png", negative)
paddingImage = add_padding(grayImage, padding)
intensityMatrix = get_non_white_pixel_locations_from_image(paddingImage, threshold, depth, "gaussian")
...
with open("THIS_IS_THE_IMAGE1.obj", "w") as f:
    # Write vertices
