...
grayImage = grayscale("ptixiaki/src/images/imagesBefore/imageGrayscale.png")

# grayImage = grayscale("grayImageCROPPED.png")
...
notWhiteList = get_non_white_pixel_locations_from_image(paddingImage, 180)
# print(notWhiteList)
...
# στο υψος θελω μονο την μπροστινη και την πισω. 
# στο πλατος αντιστοιχα. 
for z in range(0, depth):
    for y in range (0, height):
        for x in range (0, width):
            if (x == 0 or x == width - 1 or y == 0 or y == height - 1 or z == 0 or z == depth - 1):
